...
<section aria-labelledby="events">
    ...
    <ul class="card-holder">
        <li class="card card-events">
            ...
            <a target="_blank" href="category.php?id=<?= $category["1"]['id_category'];?>" class="btn card__btn">En savoir plus</a>
        </li>
        <li class="card card-events">
            ...
            <a target="_blank" href="category.php?id=<?= $category["2"]['id_category'];?>" class="btn card__btn">En savoir plus</a>
        </li>
