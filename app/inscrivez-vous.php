            ...
            <div data-step="1" class="step-1">
                ...
                <ul class="inscrivez-ul inscrivez-ul__first">
                    <li class="inscrivez-form__lname">
                        ...
                        <input pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s-]" placeholder="ex. François" class="inscrivez-form__lname-input" type="text" name="lname" id="lname" maxlength="50" required />
                    </li>
                    <li class="inscrivez-form__fname">
                        <label class="inscrivez-form__fname-label" for="fname">Prénom</label>
                        <input pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s-]" placeholder="ex. jean" class="inscrivez-form__fname-input" type="text" name="fname" maxlength="50" id="fname" required />
            ...
            <div data-step="2" class="step-2 hidden">
                ...
                <ul class="inscrivez-ul inscrivez-ul__second">
                    ...
                    <li class="inscrivez-form__city">
                        <label pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s-]" class="inscrivez-form__city-label" for="city" maxlength="50">Ville</label>
            ...
            <div data-step="3" class="step-3 hidden">
                ...
                <ul class="inscrivez-ul inscrivez-ul__third">
                    ...
                    <li class="inscrivez-form__password">
                        ...
                        <input  pattern="(?=.*?[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}" class="inscrivez-form__password-input" type="password" name="password" id="password" required />
                    </li>
